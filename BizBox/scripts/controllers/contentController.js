angular.module('BizBoxApp')
    .controller('contentController', ['$scope', '$rootScope', 'restRequestsService', '$location', 'transformerService', 
    function ($scope, $rootScope, restRequestsService, $location, transformerService) {
    $scope.loaded = true;
    var init = function () {
        var page;
        if (!page) {
